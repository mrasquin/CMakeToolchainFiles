...
set(COMPILER_SEARCH_PATHS /bgsys/drivers/ppcfloor/gnu-linux/bin/)
...
find_program(CMAKE_C_COMPILER       powerpc64-bgq-linux-gcc    ${COMPILER_SEARCH_PATHS} )
find_program(CMAKE_CXX_COMPILER     powerpc64-bgq-linux-g++    ${COMPILER_SEARCH_PATHS} )
find_program(CMAKE_Fortran_COMPILER powerpc64-bgq-linux-gfortran  ${COMPILER_SEARCH_PATHS} )
...
find_program(MPI_C_COMPILER NAMES mpicc PATHS /bgsys/drivers/ppcfloor/comm/gcc/bin/ ) 
find_program(MPI_CXX_COMPILER NAMES mpicxx PATHS /bgsys/drivers/ppcfloor/comm/gcc/bin/)
find_program(MPI_Fortran_COMPILER NAMES mpif90 mpif77 PATHS /bgsys/drivers/ppcfloor/comm/gcc/bin/)
